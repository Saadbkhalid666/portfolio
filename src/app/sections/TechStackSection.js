    ...
    >
      <div className="max-w-7xl mx-auto">
        <header className="mb-16 text-center border-b border-[#6E6E73]/30 pb-8 max-w-3xl mx-auto">
          <p className="font-instrument text-[#86868B] text-xs tracking-widest uppercase mb-3">
          ...
          <p className="mt-4 text-[#86868B] text-sm font-lily sm:text-base leading-relaxed">
        ...
        <div className="mb-16 flex justify-center w-full">
          <div className="w-full max-w-2xl bg-[#0A0A0A] border border-[#6E6E73]/30 rounded-2xl p-6 sm:p-8 backdrop-blur-md shadow-2xl">
            <SkillsRadar />
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {SKILLS_DATA.map((skill) => {
            ...
            return (
              <article
                key={skill.name}
                className="group relative bg-[#0A0A0A] border border-[#6E6E73]/30 hover:border-[#F5F5F7] rounded-xl p-6 transition-all duration-300 hover:-translate-y-1 flex flex-col justify-between shadow-lg"
              >
                <div>
