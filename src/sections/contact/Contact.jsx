    ...
    <div className="max-w-6xl mx-auto px-4 py-12">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div className="p-8 rounded-lg shadow-lg space-y-6 bg-purple-950/20 text-white border border-gray-700">
          <h2 className="text-4xl  bg-linear-to-r from-purple-600 to-white bg-clip-text text-transparent font-extrabold">Let's Work Together</h2>
          <p className="text-gray-400 text-center">For work inquiries, select your required service and message me.</p>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
            ...
            <div>
              ...
              />
              {errors.message && <p className="text-red-500 text-sm">Message required (10 chars minimum)</p>}
            </div>
...
<div className="p-8 rounded-lg space-y-6 bg-gray-950  text-white shadow-[0_0_70px_rgba(128,0,255,0.2)] hidden lg:flex flex-col justify-center">
  ...
  <p className="text-center text-white/80">Reach out directly via phone or email.</p>
  ...
  <div className="mt-6 space-y-4 text-center flex flex-col items-center gap-4">
    <div className="flex items-center gap-2">
      ...
      <a href="tel:+9203004196455" className="underline text-white hover:text-purple-400">+92 0300-4196455</a>
    </div>
    <div className="flex items-center gap-2">
      <FiMail className="text-purple-400" size={24} />
      <a href="mailto:saadbkhalid666@gmail.com" className="underline text-white hover:text-purple-400">saadbkhalid666@gmail.com</a>
    </div>
  </div>
</div>
