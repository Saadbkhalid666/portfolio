  ...
  return (
    <section id="resume" className=" text-white">
      <h1 className="bg-clip-text text-transparent
        ...
        text-center font-extrabold font-serif overflow-hidden mb-6">My Tech Stack</h1>
<p className="text-center text-lg mb-12 text-gray-400">The skills, tools and technologies I am really good at:</p>
      <div ref={containerRef} className="container mx-auto grid grid-cols-3 lg:grid-cols-6 xl:grid-cols-8 gap-10">
        {/* ===== LANGUAGES ===== */}
